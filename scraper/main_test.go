...
func TestParseDateRange(t *testing.T) {
	for _, tc := range []struct {
		...
		// special case (no separator before the date range)
		{"Nepean Sportsplex - Swim and Aquafit{ }September 14 to December 20", 9_14_0, 12_20_0},
		...
		// synthetic test cases (no separator)
		{"test test{ }January 1 to 31", 1_01_0, 1_31_0},
		{"test January test{ }January 1 to 31", 1_01_0, 1_31_0},
		{"test test{ }starting January 1", 1_01_0, 0},
		{"test January", 0, 0},
		{"test dummy January 1", 0, 0},        // single date doesn't imply separator fallback (for now)
		{"test 2 test January 1 to 31", 0, 0}, // stray number prevents fallback (for now)
...
func TestCleanActivityName(t *testing.T) {
	for _, tc := range [][]string{
		...
		{"example 15+ test 16+", // ambiguous
			"example 15+ test 16+"},
		{"example 123 test 15+",
			"example 123 (15+ years) test",
			"example 123 (15 + years) test",
			"example 123 (15+ yrs) test",
			"example 123 (15+ years old) test"},
	...
	t.Run("Actual", func(t *testing.T) {
		for _, tc := range []struct{ A, B string }{
			...
			{"Badminton - adult (18+ years)", "badminton - adult 18+"},
			{"Badminton - family (6+ years)", "badminton - family 6+"},
			...
			{"Pickleball - adult (18+ years)", "pickleball - adult 18+"},
			{"Pickleball - family (6+ years)", "pickleball - family 6+"},
			{"Basketball Family - parent with child", "basketball family - parent with child"},
			{"Basketball – child (ages 8-12)", "basketball - child (ages 8-12)"},
			{"Basketball – youth (ages 13-17)", "basketball - youth (ages 13-17)"},
